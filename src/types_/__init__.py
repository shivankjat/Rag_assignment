...
class QuestionCategory:
    ...
    BOOTSTRAP_TRAINING_QUERY = "Bootstrap Training Answer"
...
class TrainingPlanItem:
    ...
    def __str__(self):
        if self.item_type == self.ITEM_TYPE_SQL:
            return f"Train on question: {self.item_group} {self.item_name}"
        elif self.item_type == self.ITEM_TYPE_DDL:
            return f"Train on query: {self.item_group} {self.item_name}"
    ...
    **Example:**
    ...
    def remove_item(self, item: str):
        ...
        **Example:**
        ...
        plan.remove_item("Train on question: What is the average salary of employees?")
        ```
